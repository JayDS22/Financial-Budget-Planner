...
function renderCredit(){
  ...
  if(sub==='cards'){
    html+='<div class="grid gf">'+cards.map(function(c){var util=Math.round(c.current_balance/c.credit_limit*100),uc=util>50?'var(--red)':util>30?'var(--amber)':'var(--green)';return'<div class="credit-card-visual interactive-card" style="cursor:pointer;transition:all 0.2s" onclick="showCardDetail(\''+c.id+'\')"><div style="display:flex;justify-content:space-between;margin-bottom:18px"><div><div style="font-size:14px;font-weight:600">'+c.card_name+'</div><div style="font-size:10px;color:var(--t3)">'+c.issuer+' · '+c.card_type+'</div></div><span class="badge" style="background:var(--blue-g);color:var(--blue)">'+c.rewards_rate+'% '+c.rewards_type+'</span></div><div style="display:flex;align-items:center;gap:10px;margin-bottom:16px"><div class="cc-chip"></div><div class="mono" style="font-size:15px;letter-spacing:3px;color:var(--t2)">•••• '+c.last_four+'</div></div><div style="display:grid;grid-template-columns:1fr 1fr 1fr;gap:10px"><div><div style="font-size:9px;color:var(--t3);text-transform:uppercase;margin-bottom:2px">Balance</div><div class="mono" style="font-size:15px;font-weight:700">'+fmt(c.current_balance)+'</div></div><div><div style="font-size:9px;color:var(--t3);text-transform:uppercase;margin-bottom:2px">Limit</div><div class="mono" style="font-size:15px;font-weight:600">'+fmt(c.credit_limit)+'</div></div><div><div style="font-size:9px;color:var(--t3);text-transform:uppercase;margin-bottom:2px">Util.</div><div class="mono" style="font-size:15px;font-weight:600;color:'+uc+'">'+util+'%</div></div></div><div style="height:4px;border-radius:2px;background:rgba(255,255,255,.06);margin-top:12px"><div style="height:100%;width:'+util+'%;background:'+uc+';border-radius:2px"></div></div><div style="display:flex;justify-content:space-between;margin-top:10px;font-size:10px;color:var(--t3)"><span>Min: '+fmt(c.min_payment)+'</span><span>APR: '+c.apr+'%</span><span>Due: '+c.due_date+'</span></div><div style="text-align:center;margin-top:12px;font-size:10px;color:var(--blue)">Click for details →</div></div>';}).join('')+'</div>';
  }
